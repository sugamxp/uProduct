...
@section('content')
    <div class="container" style="padding: 15px;">
        ...
        <div class="row jumbotron" style="margin: 15px; padding: 15px; background-color: #d0f7cd;">
                <div class="col-md-9">
                        <h3>Summary</h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce sit amet felis et lorem condimentum convallis. Nulla egestas tortor eget ipsum volutpat viverra.</p>
                        <br>
                        <h3>Description</h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce sit amet felis et lorem condimentum convallis. Nulla egestas tortor eget ipsum volutpat viverra. Duis in tellus vel eros vestibulum hendrerit non vitae libero. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Suspendisse mattis consequat tortor, vel gravida orci porta ut. Nulla malesuada imperdiet nibh, varius venenatis urna aliquam et. Nulla facilisi. Nulla dictum, diam vitae ultricies cursus, enim quam fermentum ipsum, quis scelerisque orci nunc ut nisi. Phasellus a risus non nulla tempor pretium tristique sed metus.</p>
