                    ...
                    <div class="card" style="width: 100%; background-color: rgba(245, 245, 245, 1)">     
                            ...
                            <ul class="list-group list-group-flush">
                              ...
                              <li class="list-group-item" style="height:100px"> 
                                  <div class="row">
                                    <div class="col-md-2">
                                        <img src="/storage/cover_images/{{$prod->cover_image}}" class="rounded" alt="" width="100%" height="80px">
                                    </div>
                                    <div class="col-md-10">
                                        ...
                                        @endif
                                        @else
                                        <button type="button" class="btn btn-outline-danger btn-sm float-right popbtn"
                                        data-id="{{$prod->id}}" data-container="body" data-toggle="popover" title="Login/Register" data-trigger="focus" data-placement="top" data-content="Login or Register to Upvote this product!."><i class="fas fa-caret-up"></i> {{$prod->votes}}</button>
                                        @endif
